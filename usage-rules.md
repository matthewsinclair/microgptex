# microgptex Usage Rules

This file is the prescriptive DO / NEVER contract for working in microgptex. Narrative, rationale, and FAQs live in `AGENTS.md` and project technical docs. Each file has one job.
